...
public class plus extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.btn_signupfinish) {
            ...
            Intent mainIntent = new Intent(plus.this, login.class);

            plus.this.startActivity(mainIntent);
